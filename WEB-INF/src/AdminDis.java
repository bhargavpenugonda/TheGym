...
public class AdminDis extends HttpServlet {
    public void service(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            String qry = "select * from subscribe";
            ...
            out.println("<title>TheGym - Subscription Details</title>");
            ...
            out.println("<table>");
            out.println("<h1 style=\"background-color:#ec4141\">Subscriptions History</h1>");
            out.println("<thead>");
            out.println("<tr>");
            out.println("<th>Name</th>");
            out.println("<th>Email</th>");
            out.println("<th>Phone Number</th>");
            out.println("<th>Subscribed On</th>");
            out.println("<th>Subscription Plan</th>");
            out.println("</tr>");
            out.println("</thead>");
            out.println("<tbody>");
